...
if __name__ == '__main__':
    ...
    cubegen.orbital(mol,"./boys_homo.cube", embed.moC_occ[:,embed.mask_occ_act][:,-1])
    cubegen.orbital(mol,"./boys_lumo.cube", embed.moC_vir[:,embed.mask_vir_act][:,0])
    ...
    cubegen.orbital(mol,"./pm_homo.cube", embed.moC_occ[:,embed.mask_occ_act][:,-1])
    cubegen.orbital(mol,"./pm_lumo.cube", embed.moC_vir[:,embed.mask_vir_act][:,0])
